    ...
    public class AsyncHttpRequest
    {
        ...
        public AsyncHttpRequest(WebRequest request)
        {
            ...
            if (m_request is HttpWebRequest)
            {
                ...
                // FRAMEWORK 2.0 ((HttpWebRequest)m_request).AllowReadStreamBuffering = false;
            }
        }
                ...
                catch (Exception ex)
                {
                    ...
                    else
                    {
                        ...
                        if (ex is WebException && ((WebException)ex).Response == null)
                        {
                            ...
                            try {
                                resp = (WebResponse)r.GetType().GetProperty("Response", System.Reflection.BindingFlags.Instance | 
                                    System.Reflection.BindingFlags.NonPublic).GetValue(r, null);
                            }
                            catch { }
